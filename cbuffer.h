...
typedef struct
{
    ...
    uint32_t writer; // Index of the next write position
    uint32_t reader; // Index of the next write and read position
    uint32_t overflow; // Number of times the buffer has overflowed
